...
func (r *RedisClusterReconciler) checkAndCreateK8sObjects(ctx context.Context, req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster) (bool, error) {
...
func (r *RedisClusterReconciler) checkAndUpdateRDCL(ctx context.Context, redisName string, redisCluster *redkeyv1.RedKeyCluster) error {
...
func (r *RedisClusterReconciler) checkAndCreateConfigMap(ctx context.Context, req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster) (*corev1.ConfigMap, bool, error) {
...
func (r *RedisClusterReconciler) createConfigMap(req ctrl.Request, spec redkeyv1.RedKeyClusterSpec, secret *corev1.Secret, labels map[string]string) *corev1.ConfigMap {
...
func (r *RedisClusterReconciler) checkAndCreateStatefulSet(ctx context.Context, req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster, configMap *corev1.ConfigMap) (bool, error) {
	var immediateRequeue = false
	...
	if err != nil {
		...
		if redisCluster.Status.Status == redkeyv1.StatusUpgrading && redisCluster.Status.Substatus.Status == redkeyv1.SubstatusUpgradingScalingUp {
		...
		var err error
		if redisCluster.Status.Status == "" || redisCluster.Status.Status == redkeyv1.StatusInitializing {
...
func (r *RedisClusterReconciler) createStatefulSet(ctx context.Context, req ctrl.Request, spec redkeyv1.RedKeyClusterSpec, labels map[string]string, configmap *corev1.ConfigMap) (*v1.StatefulSet, error) {
...
func (r *RedisClusterReconciler) inferResources(req ctrl.Request, spec redkeyv1.RedKeyClusterSpec, configmap *corev1.ConfigMap, statefulSet *v1.StatefulSet) (*v1.StatefulSet, error) {
	config := spec.Config
...
func (r *RedisClusterReconciler) overrideStatefulSet(req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster, statefulSet *v1.StatefulSet) (*v1.StatefulSet, bool) {
	...
	if redisCluster.Spec.Override == nil {
		redisCluster.Spec.Override = &redkeyv1.RedKeyClusterOverrideSpec{
...
func (r *RedisClusterReconciler) checkAndCreateService(ctx context.Context, req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster) (bool, error) {
...
func (r *RedisClusterReconciler) createService(req ctrl.Request, spec redkeyv1.RedKeyClusterSpec, labels map[string]string) *corev1.Service {
...
func (r *RedisClusterReconciler) overrideService(req ctrl.Request, redisCluster *redkeyv1.RedKeyCluster, service *corev1.Service) (*corev1.Service, bool) {
	// Create a default override if it doesn't exist. This is to handle the case where the user removes the override of an existing cluster.
	if redisCluster.Spec.Override == nil {
		redisCluster.Spec.Override = &redkeyv1.RedKeyClusterOverrideSpec{
			StatefulSet: &v1.StatefulSet{},
...
func (r *RedisClusterReconciler) allPodsReady(ctx context.Context, redisCluster *redkeyv1.RedKeyCluster) (bool, error) {
...
func (r *RedisClusterReconciler) getPersistentVolumeClaim(ctx context.Context, client client.Client, redisCluster *redkeyv1.RedKeyCluster, name string) (*corev1.PersistentVolumeClaim, error) {
...
func (r *RedisClusterReconciler) getStatefulSetSelectorLabel(rdcl *redkeyv1.RedKeyCluster) string {
	return kubernetes.GetStatefulSetSelectorLabel(context.TODO(), r.Client, rdcl)
}

func (r *RedisClusterReconciler) updateStatefulSet(ctx context.Context, statefulSet *v1.StatefulSet, redisCluster *redkeyv1.RedKeyCluster) (*v1.StatefulSet, error) {
...
func (r *RedisClusterReconciler) updateDeployment(ctx context.Context, deployment *v1.Deployment, redisCluster *redkeyv1.RedKeyCluster) (*v1.Deployment, error) {
...
func (r *RedisClusterReconciler) updateRdclReplicas(ctx context.Context, redisCluster *redkeyv1.RedKeyCluster, replicas int32) (*redkeyv1.RedKeyCluster, error) {
