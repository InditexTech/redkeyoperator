...
Robin connects to all the nodes of the Redis Cluster using port 6379 and the K8s Redis Pod domain name (e.g.: redkeycluster-sample-0.redkey-cluster-sample). Therefore, a DNS resolving that name 
